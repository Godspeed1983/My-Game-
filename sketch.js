...
function preload(){
cat_running=loadAnimation("ghoot.png");
cat_collided=loadAnimation("ghost-jumping.png")
ground_image=loadImage("download (2).jfif")
coin_image=loadImage("images (2).jfif")
obstacle1=loadImage("alien1.png","alien2.png")
...
cat=createSprite(100,130,20,20);
...
text("coins:"+coin,400,20)
  ...
  cat.collide(ground)
  cat.setCollider("rectangle",1,100,100,100) 
